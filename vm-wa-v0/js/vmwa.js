...
(function () {
  ...
  if ($("#hero") && $("#heroStage")) {
    ScrollTrigger.create({
      ...
      animation: gsap.timeline()
        .to(".hero__title .line--1", { xPercent: -14, yPercent: -34, ease: "none" }, 0)
        .to(".hero__title .line--2", { xPercent: 14, yPercent: 34, ease: "none" }, 0)
        ...
        .fromTo(".hero__foot", { y: 0, opacity: 1 }, { y: 60, opacity: 0, ease: "none" }, 0)
        .to("#heroStage", { scale: 1.28, ease: "none" }, 0)
  ...
  if ($("#sweep") && $("#kontakt")) {
    gsap.timeline({ scrollTrigger: { trigger: "#kontakt", start: "top bottom", end: "top 8%", scrub: .8 } })
        .fromTo("#sweep", { scaleY: 0, transformOrigin: "50% 0%" },   { scaleY: 1, ease: "none" })
        .fromTo("#sweep", { scaleY: 1, transformOrigin: "50% 100%" }, { scaleY: 0, ease: "none" });
  }
